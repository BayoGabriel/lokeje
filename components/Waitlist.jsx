    ...
    <div className='w-full flex items-center justify-center p-[80px] relative' id='waitlist'>
      ...
      <div className="w-full wait rounded-[30px] px-[100px] py-20 flex items-center z-[2] gap-[50px]">
        ...
        <div className="relative">
          <input type="email" name='email' className='w-[610px] py-4 px-8 placeholder:text-white text-white bg-[#5E5D5C] outline-none' placeholder='Your email' />
          <button className="text-white bg-[#F9A607]">Join the waitlist</button>
        </div>
      </div>
    </div>
  )
