    ...
    <div className='flex flex-col w-full min-h-screen mt-10 max-lg:my-2'>
      ...
      <div className="w-full px-[80px] max-lg:mt-0 mt-[250px] max-md:px-[40px] max-sm:px-[20px]">
        <div className="w-full relative">
          ...
          <Image src={one} alt="one" className='absolute max-md:hidden z-[2] -top-[360px] left-4 max-md:-top-[280px] max-md:left-[20px] max-sm:-top-[150px] max-sm:left-[10px]'/>
          <Image src={two} alt="two" className='absolute max-md:hidden z-[2] -top-[320px] left-[190px] max-md:-top-[260px] max-md:left-[100px] max-sm:-top-[130px] max-sm:left-[50px]'/>
          <Image src={three} alt="three" className='absolute max-md:hidden z-[2] -top-[200px] left-[600px] max-md:-top-[180px] max-md:left-[50%] max-md:translate-x-[-50%] max-sm:-top-[110px]'/>
          <Image src={four} alt="four" className='absolute max-md:hidden z-[2] -top-[320px] right-[150px] max-md:-top-[260px] max-md:right-[80px] max-sm:-top-[130px] max-sm:right-[40px]'/>
          <Image src={five} alt="five" className='absolute max-md:hidden z-[2] -top-[160px] right-4 max-md:-top-[140px] max-md:right-[20px] max-sm:-top-[90px] max-sm:right-[10px]'/>
        </div>
      </div>
    </div>
  )
