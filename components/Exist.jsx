...
const Exist = () => {
  return (
    <div className="w-full flex flex-col items-center justify-center my-10 px-[80px]">
        <h2 className="text-[55px] font-bold text-[#E97124] text-center mb-10 uppercase">We exist to</h2>
